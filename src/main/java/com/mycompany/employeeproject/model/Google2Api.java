...
public class Google2Api extends DefaultApi20 {
    ...
    private static final String AUTHORIZE_URL = "https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=%s&redirect_uri=%s";//"https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=%s&redirect_uri=%s";
    ...
    public AccessTokenExtractor getAccessTokenExtractor() {
        ...
        return new AccessTokenExtractor() {
            ...
            public Token extract(String response) {
                ...
                String access_token = profile.getString("access_token"); 
